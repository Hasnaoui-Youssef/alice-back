...
exports.JwtAccessModule = void 0;
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const jwt_1 = require("@nestjs/jwt");
let JwtAccessModule = class JwtAccessModule {
};
exports.JwtAccessModule = JwtAccessModule;
exports.JwtAccessModule = JwtAccessModule = __decorate([
    (0, common_1.Module)({
        imports: [
